...
import { getAllTvShows } from '../../store/modules/tv/actions';
import {
  selectTvShows,
  selectCategories,
  selectIsLoadingTvShows,
  selectIsLoadingCategories,
  selectErrorMessage,
} from '../../store/modules/tv/selectors';
...
const TvScreen = ({ navigation }) => {
  ...
  const tvShows = useSelector((state) => selectTvShows(state));
  const categories = useSelector((state) => selectCategories(state));
  const isLoadingTvShows = useSelector((state) =>
    selectIsLoadingTvShows(state),
  );
      ...
      <Block width={width} style={styles.videoBlock}>
        {videoUrl ? (
          <Video
            ...
            source={{
              uri:
                'https://www.videvo.net/videvo_files/converted/2016_11/videos/GOPR6239_1.mov34724.mp4',
            }}
      ...
      <Block flex={1} width={width} style={styles.contentBlock}>
        ...
        {isLoadingTvShows ? (
          ...
          <FlatList
            ...
            refreshing={isLoadingTvShows || isLoadingCategories}
